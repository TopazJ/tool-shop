...
class App extends Component {
  state = {
    items: [
      { id: 1000, name: "Knock Bits", qty: 88, price: 12.67, supplierID: 8015 },
      { id: 1001, name: "Widgets", qty: 10, price: 35.5, supplierID: 8004 }
    ],
    itemSearch: [
      { id: 1000, name: "Knock Bits", qty: 88, price: 12.67, supplierID: 8015 },
      { id: 1001, name: "Widgets", qty: 10, price: 35.5, supplierID: 8004 }
    ...
    return (
      <React.Fragment>
        ...
        <Tab.Container id="toolshop-tabs" defaultActiveKey="items">
          <NavBar items={this.state.items} suppliers={this.state.suppliers} />
          <Tab.Content>
            <Tab.Pane eventKey="items">
              <Row>
                <Buttons importFile={this.readTextFile} type={"Item"} />
                <Tools
            ...
            <Tab.Pane eventKey="suppliers">
              <Row>
                <Buttons importFile={this.readTextFile} type={"Supplier"} />
